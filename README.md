...
| User modules | repo list in `bin/modules.sh`, fetched by `bin/mods-get.sh` into `work_mods` | `yarn mods:parse` |
...
Note: the module list is currently maintained by hand in `bin/modules.sh` — additions are welcome via pull request.
